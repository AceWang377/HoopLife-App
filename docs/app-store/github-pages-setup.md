# Blacktop GitHub Pages Setup

Blacktop's public App Store URLs are served from the repository `docs/` folder.
...
- Terms of Use URL: `https://acewang377.github.io/Blacktop-App/terms/`
- Landing page: `https://acewang377.github.io/Blacktop-App/`
- Support email: `admin@acezerotrading.com`

## Enable GitHub Pages

1. Open `https://github.com/AceWang377/Blacktop-App/settings/pages`.
...
Update this page before release if Blacktop adds accounts, submissions, analytics, payments, or photo uploads.
