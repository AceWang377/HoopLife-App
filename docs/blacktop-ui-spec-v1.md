# Blacktop UI Design Spec v1

## 1. Design Goal

Blacktop should feel like a practical basketball court utility, not a generic sports social app.
...
Introduce Blacktop in one clear idea.

Layout:

- Top: Blacktop wordmark
...
- Body: `Blacktop uses it to show nearby courts and distance. You can still browse without it.`
