# Blacktop Data Import Plan v1

## 1. Goal

Blacktop needs an initial court database before users exist. The first version should start in Sheffield, but the data pipeline should be designed so it can later expand across the UK.
...
Those fields are Blacktop's manual and user-contributed value.
...
3. Add manual columns for Blacktop-specific facts.
