        ...
        List {
            ...
            Section {
                Button {
                    ...
                    Label("Add checked court", systemImage: "plus.circle.fill")
                }
                ...
                Text("Admin edits are stored on this device for the MVP. Use this to fill Blacktop-only facts before you wire a backend.")
            }
...
struct CourtDraft {
    ...
    func makeCourt(existingID: String?) -> Court? {
        ...
        return Court(
            ...
            latitude: lat,
            longitude: lon,
            source: .blacktopManual,
            sourceLicense: "Blacktop admin entry",
